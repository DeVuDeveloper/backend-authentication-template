module Mutations
  class CreateDocument < Mutations::BaseMutation
    ...
    def resolve(doc:)
      ...
      attachment = ActiveStorage::Blob.create_and_upload!(io: doc, filename: doc.original_filename,
      ...
      if document.save
        ...
        raise GraphQL::ExecutionError.new(document.errors.full_messages.join(', '),
                                          extensions: { code: 'UNPROCESSABLE_ENTITY', errors: document.errors })
      end
    end
  end
end
